...
export default function Getinvolved() {
  ...
  return (
    <>
      ...
      <div className="min-h-screen w-full flex flex-col justify-start items-start p-20">
        ...
        <div className="flex my-4">
          <a
            ...
            className={
              ...
              " cursor-pointer lg:inline-flex lg:w-auto sm:mx-2 mx-5 px-6 py-2 rounded font-bold items-center justify-center hover:bg-yellow-500 hover:text-gray-900 "
            }
          >
            Volunteering{" "}
          </a>
